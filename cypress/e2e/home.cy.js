describe('Work From Home Management System (WFHMS)', () => {
    beforeEach(() => {
      ...
      cy.visit('http://localhost/SPM-Project-G9T3/Home/home.html'); // Adjust the URL if necessary
    ...
    it('should navigate to manage WFH applications', () => {
      ...
      cy.url().should('include', 'http://localhost/SPM-Project-G9T3/ManageApplication/mapplication.html');
    });
    ...
    it('should navigate to view team schedule', () => {
      ...
      cy.url().should('include', 'http://localhost/SPM-Project-G9T3/ViewTeamSchedule/vtSchedule.html');
    });
    ...
    it('should log out and redirect to login page', () => {
      ...
      cy.url().should('include', 'http://localhost/SPM-Project-G9T3/Login&Authentication/login.html');
    });
