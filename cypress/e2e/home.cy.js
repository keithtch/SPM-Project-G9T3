describe('Work From Home Management System (WFHMS)', () => {
    beforeEach(() => {
      ...
      cy.visit('http://localhost:8000/SPM-Project-G9T3/Home/home.html'); // Adjust the URL if necessary
    ...
    it('should navigate to apply for WFH', () => {
      ...
      cy.url().should('include', 'http://localhost:8000/SPM-Project-G9T3/Application/application.html');
    });
    ...
    it('should navigate to manage WFH applications', () => {
      ...
      cy.url().should('include', 'http://localhost:8000/SPM-Project-G9T3/ManageApplication/mapplication.html');
    });
    ...
    it('should navigate to view own schedule', () => {
      ...
      cy.url().should('include', 'http://localhost:8000/SPM-Project-G9T3/ViewOwnSchedule/voSchedule.html');
    });
    ...
    it('should navigate to view team schedule', () => {
      ...
      cy.url().should('include', 'http://localhost:8000/SPM-Project-G9T3/ViewTeamSchedule/vtSchedule.html');
    });
    ...
    it('should log out and redirect to login page', () => {
      ...
      cy.url().should('include', 'http://localhost:8000/SPM-Project-G9T3/Login&Authentication/login.html');
    });
